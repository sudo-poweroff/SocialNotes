...
public class SetNewPassword {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(!Validation.validatePassword(password1)){
            ...
            RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/setNewPassword.jsp");
            ...
            if(!password1.equals(password2)){
                ...
                try {
                    ...
                    request.setAttribute("error",error);
                    RequestDispatcher dispatcher2 = request.getServletContext().getRequestDispatcher("/setNewPassword.jsp");
