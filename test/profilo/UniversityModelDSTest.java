...
public class UniversityModelDSTest extends DataSourceBasedDBTestCase{
	...
	public void testDoRetrieveAll() throws Exception{
		...
		b1.setDescrizione("Univerist� della Lombardia");
		...
		b2.setDenominazione("Universit� Degli Studi Di Salerno");
		b2.setDescrizione("Univerist� degli studi di Salerno");
	...
	public void testdoRetrieveAllNotPresent() throws SQLException{
		...
		ds.getConnection().prepareStatement("DELETE FROM Universita WHERE Denominazione='Universit� Degli Studi Di Salerno'").execute();
